    ...
    public class PlayniteTools
    {
        ...
        public static bool GameUseXbox360(Game game)
        {
            ...
            foreach (GameAction action in game.GameActions)
            {
                ...
                if (BuiltInConfigId.Contains("Xenia", StringComparison.OrdinalIgnoreCase)
                    || emulator.Name.Contains("Xenia", StringComparison.OrdinalIgnoreCase)
                    || emulator.InstallDir.Contains("Xenia", StringComparison.OrdinalIgnoreCase))
                {
                    return true;
                }
            }
